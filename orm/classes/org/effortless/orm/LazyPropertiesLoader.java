...
public class LazyPropertiesLoader extends Object implements PropertiesLoader {

	public LazyPropertiesLoader (AbstractEntity e) {
		super();
		this._pivot = e;
	}
	...
	public String getColumns () {
		return this._pivot._columnsLazy();
	}
	...
	public void load(Object res, DbManager db, ResultSet rs) {
		this._pivot._loadLazy(res, db, rs);
	}
